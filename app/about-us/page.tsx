...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    role: "PARTNER",
    description: [
      "Comes from a multifaceted experience in creating and composing innovative Start-Ups where she developed the core functions and work coordination processes, and which saw her personally involved in resolving administrative, financial, and legal difficulties.",
      <>In 2013, she founded <a href="https://ivhgroup.it/" target="_blank" rel="noopener noreferrer" className="text-[#37B6B6] hover:underline">IVH Group S.p.A.</a> together with Andrea Chiappini and in ten years of work brought the company from a start-up to a solid group recognized in the Italian tourism industry.</>,
      "At the same time, she founded a multifunctional space in Corso Europa, IVH SPACE – Bleisure Corteccia, Milan, coordinating its construction and artistic direction.",
      "The previous years saw her consolidate in professional coaching, after extensive personal training, ranging from commercial development to human resources.",
    ],
    imagePath: "/landing-page/about-us/5 Nicla Leo.jpg",
  },
  {
    name: "Valerio Maggi",
    role: "IT MANAGER",
