import { AdminProfileCompletionForm } from '@/components/auth/admin-profile-completion-form'
    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#F7F8F9] px-4 py-8">
      ...
      <Card className="w-full max-w-[400px] shadow-lg border-[#E0E0E0]">
        <CardHeader className="space-y-2 pb-4">
          <CardTitle className="text-2xl font-bold text-[#142D42]">Complete Administrator Profile</CardTitle>
          <CardDescription className="text-gray-500">
            Set up your administrator profile to access the management dashboard
          </CardDescription>
        </CardHeader>
        <CardContent>
